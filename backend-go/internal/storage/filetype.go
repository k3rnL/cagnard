...
var extensionTypes = map[string]fileTypeDefinition{
	...
	".jsonl":   textType("application/x-ndjson", "ndjson", "file-json"),
	".ndjson":  textType("application/x-ndjson", "ndjson", "file-json"),
	...
	".parquet": binaryType("application/vnd.apache.parquet", "analytical-data", "file-box"),
	".avro":    binaryType("application/avro", "analytical-data", "file-box"),
...
var exactMIMETypes = map[string]fileTypeDefinition{
	...
	"application/ndjson":                  extensionTypes[".jsonl"],
	"application/jsonl":                   extensionTypes[".jsonl"],
	"text/csv":                            extensionTypes[".csv"],
	"application/csv":                     extensionTypes[".csv"],
	...
	"application/vnd.apache.parquet":      extensionTypes[".parquet"],
	"application/x-parquet":               extensionTypes[".parquet"],
	"application/avro":                    extensionTypes[".avro"],
	"application/x-avro":                  extensionTypes[".avro"],
	"application/vnd.apache.avro":         extensionTypes[".avro"],
	"application/vnd.apache.arrow":        extensionTypes[".arrow"],
