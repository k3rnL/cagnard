...
const extensionDefinitions: Record<string, FileTypeDefinition> = {
  ...
  ".jsonl": text("application/x-ndjson", "JSON Lines", "ndjson", "file-json"),
  ".ndjson": text("application/x-ndjson", "JSON Lines", "ndjson", "file-json"),
  ...
  ".parquet": binary("application/vnd.apache.parquet", "analytical-data", "file-box", "Parquet data"),
  ".avro": binary("application/avro", "analytical-data", "file-box", "Avro data"),
...
const exactMimeDefinitions: Record<string, FileTypeDefinition> = {
  ...
  "application/ndjson": extensionDefinitions[".jsonl"],
  "application/jsonl": extensionDefinitions[".jsonl"],
  "text/csv": extensionDefinitions[".csv"],
  "application/csv": extensionDefinitions[".csv"],
  ...
  "application/vnd.apache.parquet": extensionDefinitions[".parquet"],
  "application/x-parquet": extensionDefinitions[".parquet"],
  "application/avro": extensionDefinitions[".avro"],
  "application/x-avro": extensionDefinitions[".avro"],
  "application/vnd.apache.avro": extensionDefinitions[".avro"],
...
export function isTextCategory(category: string | undefined): boolean {
  return ["code", "config", "csv", "json", "log", "markdown", "ndjson", "text", "xml", "yaml"].includes(category ?? "");
}
